...
public class GexinghuajianyiEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public GexinghuajianyiEntity() {
		
	}
	
	public GexinghuajianyiEntity(T t) {
		try {
	...
	private String jianyimingcheng;
	 ...
	 * 设置：建议名称
	 */
	public void setJianyimingcheng(String jianyimingcheng) {
		this.jianyimingcheng = jianyimingcheng;
	}
	/**
	 * 获取：建议名称
	 */
	public String getJianyimingcheng() {
		return jianyimingcheng;
	}
	/**
	 * 设置：建议内容
	 */
