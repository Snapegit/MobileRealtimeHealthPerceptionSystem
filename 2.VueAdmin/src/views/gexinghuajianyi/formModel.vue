		...
		<el-dialog v-model="formVisible" :title="formTitle" width="80%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" label-width="$template2.back.add.form.base.labelWidth" :rules="rules">
				<el-row>
					...
					<el-col :span="24">
						<el-form-item label="建议名称" prop="jianyimingcheng">
							<el-input class="list_inp" v-model="form.jianyimingcheng" placeholder="建议名称"
								 type="text" 								:readonly="!isAdd||disabledForm.jianyimingcheng?true:false" />
						</el-form-item>
					</el-col>
					...
					<el-col :span="24">
						<el-form-item label="建议内容" prop="jianyineirong">
							<el-input v-model="form.jianyineirong" placeholder="建议内容" type="textarea"
							:readonly="!isAdd||disabledForm.jianyineirong?true:false"
							/>
						</el-form-item>
					</el-col>
				</el-row>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='jianyimingcheng'){
					form.value.jianyimingcheng = row[x];
					disabledForm.value.jianyimingcheng = true;
					continue;
				}
				if(x=='jianyineirong'){
