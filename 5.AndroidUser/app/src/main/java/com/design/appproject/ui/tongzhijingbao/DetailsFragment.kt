...
import com.design.appproject.logic.viewmodel.tongzhijingbao.DetailsViewModel
import androidx.activity.viewModels
import com.youth.banner.adapter.BannerImageAdapter
import com.youth.banner.holder.BannerImageHolder
import com.alibaba.android.arouter.facade.annotation.Autowired
import com.alibaba.android.arouter.facade.annotation.Route
import com.design.appproject.databinding.TongzhijingbaocommonDetailsLayoutBinding
 ...
 * 通知警报详情页
 */
@Route(path = CommonArouteApi.PATH_FRAGMENT_DETAILS_TONGZHIJINGBAO)
class DetailsFragment : BaseBindingFragment<TongzhijingbaocommonDetailsLayoutBinding>() {
    ...
    private var mTongzhijingbaoItemBean=TongzhijingbaoItemBean()/*详情内容*/
    ...
    override fun initData() {
        ...
        mDetailsViewModel.infoLiveData.observeKt(errorBlock = {binding.srv.isRefreshing =false}) {
            it.getOrNull()?.let { info->
                ...
                mTongzhijingbaoItemBean = info.data
                 binding.setInfo()
            }
        }
    ...
    private fun loadData(){
        mDetailsViewModel.info("tongzhijingbao",mId.toString())
    }


    private fun TongzhijingbaocommonDetailsLayoutBinding.setInfo(){
        zhanghaoTv.text = "${mTongzhijingbaoItemBean.zhanghao}"
        biaotiTv.text = "${mTongzhijingbaoItemBean.biaoti}"
        tixingneirongTv.text = "${mTongzhijingbaoItemBean.tixingneirong}"
        tixingshijianTv.text = "${mTongzhijingbaoItemBean.tixingshijian}"
    }
