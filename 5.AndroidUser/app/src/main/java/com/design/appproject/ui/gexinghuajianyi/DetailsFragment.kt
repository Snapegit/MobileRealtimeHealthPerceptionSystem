...
import com.design.appproject.logic.viewmodel.gexinghuajianyi.DetailsViewModel
import androidx.activity.viewModels
import com.youth.banner.adapter.BannerImageAdapter
import com.youth.banner.holder.BannerImageHolder
import com.alibaba.android.arouter.facade.annotation.Autowired
import com.alibaba.android.arouter.facade.annotation.Route
import com.design.appproject.databinding.GexinghuajianyicommonDetailsLayoutBinding
 ...
 * 个性化建议详情页
 */
@Route(path = CommonArouteApi.PATH_FRAGMENT_DETAILS_GEXINGHUAJIANYI)
class DetailsFragment : BaseBindingFragment<GexinghuajianyicommonDetailsLayoutBinding>() {
    ...
    private var mGexinghuajianyiItemBean=GexinghuajianyiItemBean()/*详情内容*/


    @SuppressLint("SuspiciousIndentation")
    override fun initEvent() {
        setBarTitle("个性化建议详情页")
    ...
    override fun initData() {
        ...
        mDetailsViewModel.infoLiveData.observeKt(errorBlock = {binding.srv.isRefreshing =false}) {
            it.getOrNull()?.let { info->
                ...
                mGexinghuajianyiItemBean = info.data
                 binding.setInfo()
            }
        }
    ...
    private fun loadData(){
        mDetailsViewModel.info("gexinghuajianyi",mId.toString())
    }


    private fun GexinghuajianyicommonDetailsLayoutBinding.setInfo(){
        zhanghaoTv.text = "${mGexinghuajianyiItemBean.zhanghao}"
        jianyimingchengTv.text = "${mGexinghuajianyiItemBean.jianyimingcheng}"
        jianyineirongTv.text = "${mGexinghuajianyiItemBean.jianyineirong}"
        jianyishijianTv.text = "${mGexinghuajianyiItemBean.jianyishijian}"
    }
